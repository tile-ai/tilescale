...
// get_local_base() returns u64 since I could not find a way cast u64 to ptr in tir
...
template <typename dtype_t> TL_HOST_DEVICE uint64_t get_uintptr_t(dtype_t *ptr) {
